...
It requires three files:
 ...
 2. protein_existence_summary_isoforms_merged.csv: Generated by running the 2.1 df_merge_retrieved.py script. Contains a summary of the existence levels, and the new merged accessions codes
 3. ptms_dbptm.csv: Generated by running the 2.1 df_merge_retrieved.py script. It contains ptm information of the unique accession codes of dbPTM/CPLM that were not merged.
"""
